    ...
    <>
      <div className="admin-add-product">
        <div className="admin-add-product-container">
         ...
         <div>
         <button className="admin-image-upload-add-button">Upload Image</button>
         <button className="admin-image-upload-add-button" style={{marginTop:"1rem"}}>Add Product Now</button>
         </div>
          </div>
        </div>
      </div>
